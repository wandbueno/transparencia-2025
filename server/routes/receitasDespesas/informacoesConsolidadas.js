...
const fetchFromAPI = async (path, req, res) => {
  try {
    ...
    const params = {
      ...
      codigoDaFase: otherParams.codigoDaFase,
      codigoDaFuncao: otherParams.codigoDaFuncao,
      codigoDaOrdemDePagamento: otherParams.codigoDaOrdemDePagamento,
      ...
      codigoDoOrgaoDaUnidade: otherParams.codigoDoOrgaoDaUnidade,
      cpfCnpj: otherParams.cpfCnpj,
      dataFinal: otherParams.dataFinal,
      dataInicial: otherParams.dataInicial,
      ...
      valorPago: otherParams.valorPago,
