...
const fetchFromAPI = async (path, req, res) => {
  try {
    ...
    const params = {
      ...
      cpfCnpjDoBeneficiario: otherParams.cpfCnpjDoBeneficiario,
      ...
      nomeDoBeneficiario: otherParams.nomeDoBeneficiario,
      orgaoDoCliente: otherParams.orgaoDoCliente,
      valorConcedido: otherParams.valorConcedido,
...
router.get('/data-de-atualizacao', (req, res) =>
  fetchFromAPI(
    '/api/receitas-e-despesas/transferencia-voluntaria-realizada/data-de-atualizacao',
    req,
    res
  )
)
...
router.get('/detalhe', (req, res) =>
  fetchFromAPI(
    '/api/receitas-e-despesas/transferencia-voluntaria-realizada/detalhe',
    req,
    res
  )
)
...
router.get('/paginado', (req, res) =>
  fetchFromAPI(
    '/api/receitas-e-despesas/transferencia-voluntaria-realizada/paginado',
    req,
    res
  )
)
...
router.get('/:id', (req, res) => {
  ...
  fetchFromAPI(
    `/api/receitas-e-despesas/transferencia-voluntaria-realizada/detalhe?chavePrimaria=${id}`,
    req,
    res
  )
})
