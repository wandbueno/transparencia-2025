...
const fetchFromAPI = async (path, req, res) => {
  try {
    ...
    const params = {
      ...
      anoDaDividaAtiva: otherParams.anoDaDividaAtiva,
      anoFinalDaDividaAtiva: otherParams.anoFinalDaDividaAtiva,
      anoInicialDaDividaAtiva: otherParams.anoInicialDaDividaAtiva,
      ...
      nomeDoContribuinte: otherParams.nomeDoContribuinte,
